...
struct Body *crypt_pgp_encrypt_message(struct Email *e, struct Body *b, char *keylist, int sign, const AddressList *from);
char *       crypt_pgp_find_keys(AddressList *al, bool oppenc_mode);
...
char *       crypt_smime_find_keys(AddressList *al, bool oppenc_mode);
