...
static const struct Command MuttCommands[] = {
  ...
  { "hdr_order",           parse_gslist,           IP &HeaderOrderList },
  { "ifdef",               parse_ifdef,            0 },
  ...
  { "mailto_allow",        parse_gslist,           IP &MailToAllow },
  { "mime_lookup",         parse_gslist,           IP &MimeLookupList },
  ...
  { "unhdr_order",         parse_ungslist,         IP &HeaderOrderList },
  { "unignore",            parse_unignore,         0 },
  { "unlists",             parse_unlists,          0 },
  { "unmacro",             mutt_parse_unbind,      MUTT_UNMACRO },
  { "unmailboxes",         parse_unmailboxes,      0 },
  { "unmailto_allow",      parse_ungslist,         IP &MailToAllow },
  { "unmime_lookup",       parse_ungslist,         IP &MimeLookupList },
