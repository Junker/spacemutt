...
static int ppanel_config_observer(struct NotifyCallback *nc)
{
  ...
  {
    window_status_on_top(panel_pager, SpaceMutt->sub);
...
static int ppanel_window_observer(struct NotifyCallback *nc)
{
  ...
  notify_observer_remove(SpaceMutt->sub->notify, ppanel_config_observer, panel_pager);
...
struct MuttWindow *ppanel_new(bool status_on_top, struct IndexSharedData *shared)
{
  ...
  notify_observer_add(SpaceMutt->sub->notify, NT_CONFIG, ppanel_config_observer, panel_pager);
